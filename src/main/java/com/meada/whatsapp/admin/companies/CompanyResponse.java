 ...
 *
 * <p>Campos escolhidos para a listagem: id, name, slug, status (active|suspended) e
 * createdAt. {@code updated_at} é omitido — metadado de manutenção sem valor na lista
 * do MVP (adicionar se uma tela futura precisar). {@code createdAt} serializa como
 * ISO-8601 (padrão Jackson para Instant).
 *
 ...
 */
public record CompanyResponse(UUID id, String name, String slug, String status, Instant createdAt) {
}
