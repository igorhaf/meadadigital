...
import com.meada.profiles.comida.coupons.ComidaCouponService.CouponNotFoundException;
import com.meada.profiles.comida.coupons.ComidaCouponService.DuplicateCouponException;
import com.meada.profiles.comida.coupons.ComidaCouponService.InvalidCouponException;
...
public class ComidaCouponController {
    ...
    private final ComidaCouponService service;
    private final ComidaProfileGuard profileGuard;

    public ComidaCouponController(ComidaCouponService service, ComidaProfileGuard profileGuard) {
    ...
    @GetMapping("/api/comida/coupons/{id}")
    ...
    @PostMapping("/api/comida/coupons")
    ...
    @PatchMapping("/api/comida/coupons/{id}")
    ...
    @PatchMapping("/api/comida/coupons/{id}/toggle")
    ...
    @DeleteMapping("/api/comida/coupons/{id}")
