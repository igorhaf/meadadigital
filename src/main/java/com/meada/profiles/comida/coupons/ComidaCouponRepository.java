...
/**
 * Acesso a {@code comida_coupons} — subclasse FINA do motor comum {@link CouponRepositoryBase}
 * (unificação 2026-07 dos 7 clones de cupom; SQL e semântica vivem na base).
 */
@Repository
public class ComidaCouponRepository extends CouponRepositoryBase<ComidaCoupon> {
    ...
    @Override
    protected RowMapper<ComidaCoupon> mapper() {
        return MAPPER;
    }
}
