...
/**
 * Config de fidelidade do tenant comida (onda 1 do comida, backlog #2 — clone do chassi sushi). TENANT +
 * perfil 'comida' only. GET (com fallback p/ defaults) + PUT (upsert). Sob {@code /api/comida/**}.
 */
@RestController
public class ComidaLoyaltyConfigController {

    private final ComidaLoyaltyConfigService service;
    private final ComidaProfileGuard profileGuard;

    public ComidaLoyaltyConfigController(ComidaLoyaltyConfigService service, ComidaProfileGuard profileGuard) {
