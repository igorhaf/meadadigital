...
public class AprovacaoViagemHandler {
     ...
     * em caso de sucesso.
     */
    public Optional<TravelProposal> parseAndApply(UUID companyId, UUID conversationId, UUID contactId,
        ...
        if (contactId == null || !java.util.Objects.equals(current.get().contactId(), contactId)) {
            log.warn("viagens: <aprovacao_viagem> em proposta de outro contato (proposta {} contato {} ≠ conversa {}) — bloqueada",
