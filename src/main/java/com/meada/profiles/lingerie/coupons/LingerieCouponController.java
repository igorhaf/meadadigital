...
/**
 * Cupons de desconto do tenant lingerie (camada 8.9, backlog #1 — clone do chassi sushi). TENANT +
 * perfil 'lingerie' only. CRUD do catálogo de cupons; a aplicação acontece na criação do pedido. Sob
 * {@code /api/lingerie/**}.
 */
@RestController
public class LingerieCouponController {

    private final LingerieCouponService service;
    private final LingerieProfileGuard profileGuard;

    public LingerieCouponController(LingerieCouponService service, LingerieProfileGuard profileGuard) {
    ...
    @GetMapping("/api/lingerie/coupons")
    ...
    @GetMapping("/api/lingerie/coupons/{id}")
    ...
    @PostMapping("/api/lingerie/coupons")
    ...
    @PatchMapping("/api/lingerie/coupons/{id}")
    ...
    @PatchMapping("/api/lingerie/coupons/{id}/toggle")
    ...
    @DeleteMapping("/api/lingerie/coupons/{id}")
