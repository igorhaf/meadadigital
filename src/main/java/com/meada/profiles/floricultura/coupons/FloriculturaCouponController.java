...
/**
 * Cupons de desconto do tenant floricultura (camada 8.5, backlog #1 — clone do chassi sushi). TENANT +
 * perfil 'floricultura' only. CRUD do catálogo de cupons; a aplicação acontece na criação do pedido. Sob
 * {@code /api/floricultura/**}.
 */
@RestController
public class FloriculturaCouponController {

    private final FloriculturaCouponService service;
    private final FloriculturaProfileGuard profileGuard;

    public FloriculturaCouponController(FloriculturaCouponService service, FloriculturaProfileGuard profileGuard) {
    ...
    @GetMapping("/api/floricultura/coupons")
    ...
    @GetMapping("/api/floricultura/coupons/{id}")
    ...
    @PostMapping("/api/floricultura/coupons")
    ...
    @PatchMapping("/api/floricultura/coupons/{id}")
    ...
    @PatchMapping("/api/floricultura/coupons/{id}/toggle")
    ...
    @DeleteMapping("/api/floricultura/coupons/{id}")
