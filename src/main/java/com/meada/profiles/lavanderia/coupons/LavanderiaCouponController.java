...
/**
 * Cupons de desconto do tenant lavanderia (camada 8.10, backlog #1 — clone do chassi sushi). TENANT +
 * perfil 'lavanderia' only. CRUD do catálogo de cupons; a aplicação acontece na criação do pedido. Sob
 * {@code /api/lavanderia/**}.
 */
@RestController
public class LavanderiaCouponController {

    private final LavanderiaCouponService service;
    private final LavanderiaProfileGuard profileGuard;

    public LavanderiaCouponController(LavanderiaCouponService service, LavanderiaProfileGuard profileGuard) {
    ...
    @GetMapping("/api/lavanderia/coupons")
    ...
    @GetMapping("/api/lavanderia/coupons/{id}")
    ...
    @PostMapping("/api/lavanderia/coupons")
    ...
    @PatchMapping("/api/lavanderia/coupons/{id}")
    ...
    @PatchMapping("/api/lavanderia/coupons/{id}/toggle")
    ...
    @DeleteMapping("/api/lavanderia/coupons/{id}")
