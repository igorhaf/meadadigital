...
/**
 * Cupons de desconto do tenant pizzaria (camada 8.9, backlog #1 — clone do chassi sushi). TENANT +
 * perfil 'pizzaria' only. CRUD do catálogo de cupons; a aplicação acontece na criação do pedido. Sob
 * {@code /api/pizzaria/**}.
 */
@RestController
public class PizzariaCouponController {

    private final PizzariaCouponService service;
    private final PizzariaProfileGuard profileGuard;

    public PizzariaCouponController(PizzariaCouponService service, PizzariaProfileGuard profileGuard) {
    ...
    @GetMapping("/api/pizzaria/coupons")
    ...
    @GetMapping("/api/pizzaria/coupons/{id}")
    ...
    @PostMapping("/api/pizzaria/coupons")
    ...
    @PatchMapping("/api/pizzaria/coupons/{id}")
    ...
    @PatchMapping("/api/pizzaria/coupons/{id}/toggle")
    ...
    @DeleteMapping("/api/pizzaria/coupons/{id}")
