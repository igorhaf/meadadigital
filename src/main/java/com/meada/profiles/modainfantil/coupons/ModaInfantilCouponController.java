...
/**
 * Cupons de desconto do tenant modainfantil (camada 8.9, backlog #1 — clone do chassi sushi). TENANT +
 * perfil 'modainfantil' only. CRUD do catálogo de cupons; a aplicação acontece na criação do pedido. Sob
 * {@code /api/modainfantil/**}.
 */
@RestController
public class ModaInfantilCouponController {

    private final ModaInfantilCouponService service;
    private final ModaInfantilProfileGuard profileGuard;

    public ModaInfantilCouponController(ModaInfantilCouponService service, ModaInfantilProfileGuard profileGuard) {
    ...
    @GetMapping("/api/moda-infantil/coupons")
    ...
    @GetMapping("/api/moda-infantil/coupons/{id}")
    ...
    @PostMapping("/api/moda-infantil/coupons")
    ...
    @PatchMapping("/api/moda-infantil/coupons/{id}")
    ...
    @PatchMapping("/api/moda-infantil/coupons/{id}/toggle")
    ...
    @DeleteMapping("/api/moda-infantil/coupons/{id}")
