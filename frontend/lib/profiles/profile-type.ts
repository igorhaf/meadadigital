...
export const PROFILES = [
  ...
  {
    id: 'floricultura',
    productName: 'Floricultura',
    subdomain: 'floricultura',
    defaultPaletteId: 'rosa-po',
  },
  ...
  { id: 'casamento', productName: 'Casamento', subdomain: 'casamento', defaultPaletteId: 'trigo' },
  {
    ...
    subdomain: 'concessionaria',
    defaultPaletteId: 'meia-noite',
  },
  {
    id: 'lavanderia',
    productName: 'Lavanderia',
    subdomain: 'lavanderia',
    defaultPaletteId: 'oceano',
  },
  {
    id: 'dermatologia',
    productName: 'Dermatologia',
    subdomain: 'dermatologia',
    defaultPaletteId: 'teal',
  },
  {
    id: 'fotografia',
    productName: 'Fotografia',
    subdomain: 'fotografia',
    defaultPaletteId: 'carvao',
  },
  ...
  {
    id: 'moda_infantil',
    productName: 'Moda Infantil',
    subdomain: 'moda-infantil',
    defaultPaletteId: 'por-do-sol',
  },
