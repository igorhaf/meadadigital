...
import {
  LINGERIE_CATEGORIES,
  type LingerieCategoryId,
} from '@/profiles/lingerie/lingerie-categories'
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select
                value={form.category}
                onChange={(e) =>
                  setForm((f) => ({ ...f, category: e.target.value as LingerieCategoryId }))
                }
                className="w-full rounded-md border border-border bg-background px-3 py-2 text-sm"
              >
    ...
    <div className="space-y-4">
      ...
      >
        <div className="w-24">
          ...
          <select
            value={form.size}
            onChange={(e) => setForm((f) => ({ ...f, size: e.target.value as LingerieSizeId }))}
