...
export default function ViagensConsultantsPage() {
  ...
  const saveMutation = useMutation({
    mutationFn: () => {
      ...
      return createConsultant({ name: form.name, specialty: form.specialty || null, notes: form.notes || null })
    },
    onSuccess: () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title={editing ? 'Editar consultor' : 'Novo consultor'} size="md">
