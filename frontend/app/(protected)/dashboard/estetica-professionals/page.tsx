...
export default function EsteticaProfessionalsPage() {
  ...
  const saveMutation = useMutation({
    mutationFn: () => {
      if (editing) {
        return updateProfessional(editing.id, { name: form.name, specialty: form.specialty || null, notes: form.notes || null })
      }
      return createProfessional({ name: form.name, specialty: form.specialty || null, notes: form.notes || null })
    },
    onSuccess: () => {
