...
export default function TeamPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Equipe"
        description="Membros da empresa e convites para administradores extras."
        actions={<Button onClick={() => setDialogOpen(true)}>Novo convite</Button>}
      />

      {/* Membros atuais */}
      <Section title="Membros atuais">
